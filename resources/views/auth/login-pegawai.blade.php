...
<style>
    /* ===== VARIABLES & THEME - PEGAWAI (KUNING MADU) ===== */
    :root {
        --amber-50: #fffbeb;
        --amber-100: #fef3c7;
        --amber-200: #fde68a;
    ...
    /* ===== BASE STYLES ===== */
    body {
        background: linear-gradient(145deg, var(--amber-600), var(--amber-700));
        min-height: 100vh;
        margin: 0;
    ...
    .triangle-1 {
        ...
        border-color: transparent transparent var(--amber-300) transparent;
        top: -100px;
        left: -100px;
    ...
    .triangle-2 {
        ...
        border-color: transparent transparent var(--amber-400) transparent;
        bottom: -100px;
        right: -80px;
    ...
    /* ===== LEFT PANEL - PEGAWAI (KUNING MADU) ===== */
    .elegant-left {
    ...
    .brand-name {
        ...
        background: linear-gradient(135deg, #fff, var(--amber-200));
    ...
    /* ===== RIGHT PANEL - PEGAWAI (KUNING SANGAT MUDA) ===== */
    .elegant-right {
        padding: 4rem 3rem;
    ...
    .elegant-input {
        ...
        background: white;
        border: 2px solid rgba(147, 64, 14, 0.1);
        border-radius: 12px;
        font-size: 1rem;
        color: var(--charcoal);
    ...
    /* ===== ELEGANT BUTTON - PEGAWAI (KUNING MADU) ===== */
    .elegant-btn {
        width: 100%;
        padding: 1.25rem;
    ...
    .login-footer {
        ...
        text-align: center;
        padding-top: 2rem;
        border-top: 1px solid rgba(147, 64, 14, 0.1);
    }
                    ...
                    <div class="feature-grid">
                        <div class="feature-item">
                            ...
                            <div class="feature-content">
                                <h5>Akses Personal</h5>
                                <p>Setiap pegawai memiliki akun sendiri.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <div class="feature-content">
                                <h5>Cetak Informasi Penghasilan</h5>
                                <p>Lihat dan cetak kapan saja.</p>
                            </div>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <div class="feature-content">
                                <h5>Terjamin Privasinya</h5>
                                <p>Informasi Penghasilan dan Laporan Perjadin hanya bisa dilihat pemilik akun.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="elegant-right">
                    <div class="login-header">
                        <h3>Login Pegawai</h3>
                        <p>Masukkan NIP dan password untuk mengakses SIPADI</p>
                    </div>
